	...
	"powereffect": [
		{
			...
			"entries": [
				"You can impose some debilitating condition or conditions on a target by making a close attack. You set the conditions your Affliction causes at each degree when you acquire it and they may not be changed. Higher degree conditions replace lower degree conditions and do not stack with them. See the possible conditions for each degree under the Affliction Resistance Check table. The target resists with Fortitude or Will defense (chosen when you take the effect):",
				{
					...
					"func": "Fortitude or Will vs. DC [Affliction rank + 10]",
					"entries": [
						{
							"type": "list",
							"items": [
			...
			"extras": [
				...
				{
					"name": "Concentration",
					"entries": ["Once you have hit with a Concentration Affliction, so long as you continue to take a standard action each turn to maintain the effect, the target must make a new resistance check against it, with no attack check required."],
					"cost": {
						"value": 1, "type": "per"
					}
				},
				...
				},
				{
					...
					"entries": ["Your Affliction imposes an additional condition per degree of success. So with one application of this extra, your Affliction imposes two conditions—such as dazed and hindered, or impaired and vulnerable—rather than just one. With two applications, it imposes three conditions, and so forth. Since mutually incompatible conditions are largely wasted, Afflictions with this extra often have the Limited Degree flaw as well."],
					"cost": {
						"value": 1, "type": "per"
					}
				},
			...
			"flaws": [
				...
				{
					"name": "Limited Degree",
					"entries": ["Your Affliction is limited to no more than two degrees of effect. With two applications of this modifier, it is limited to no more than one degree of effect."],
					"cost": {
						"value": -1, "type": "per"
					}
				}
